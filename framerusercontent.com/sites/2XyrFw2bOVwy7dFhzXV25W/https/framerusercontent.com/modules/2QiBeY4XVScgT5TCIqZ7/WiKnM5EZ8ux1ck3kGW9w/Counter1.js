...
export function Counter(props) {
    ...
    useEffect(() => {
        const updateCount = () => {
            const increment = incrementType === "integer" ? 1 : .1;
            setCount(prevCount => {
    ...
    }, [count, start, end, loop, isVisible, speed, startOnViewport, incrementType]);
    useEffect(() => {
...
addPropertyControls(Counter, {
    ...
    loop: {
        ...
        enabledTitle: "On",
        disabledTitle: "Off",
        description: "[Built by Asif Kabir](https://www.youtube.com/channel/UCujbStV-Rp-QGfiHOKA9AvA)"
    }
});
